...
Configs:   /opt/examples/      (11 mem techs, 5 cores, 8 NoC topos, 2 net models)
Cosim:     /opt/examples/cosim/         (host+device YAMLs)
Workloads: /opt/benchmarks/            (built PIM kernels, classic, NPB)
Cosim wl:  /opt/pimid/cosim_workloads/       (built cosim kernels)
