...
public:
    ...
    /**
     * NoC activity statistics from Garnet simulation
     * Used for dynamic power calculation
     */
    struct NoCActivityStats {
        ...
        double clock_mhz;              // NoC clock frequency
    ...
    struct SystemConfig {
        ...
        SystemConfig()
            ...
            , noc_input_ports(5)   // 4 directions + local
            , noc_output_ports(5)
            , noc_vcs_per_vnet(4)
    ...
    // Set NoC activity from Garnet simulation
...
private:
    ...
    // NoC activity stats (from Garnet)
