...
int main() {
    ...
    std::cout << "✓ Model registered successfully" << std::endl;
    ...
    std::cout << "✓ Sent 10 packets" << std::endl;
    ...
    std::cout << "✓ Ran 100 cycles" << std::endl;
    ...
    std::cout << "✓ Latency query successful" << std::endl;
